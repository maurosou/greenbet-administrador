...
var Sego = function(){
	...
	var handleNavigation = function() {
		console.log(document.getElementsByClassName("nav-control").length);
	...
	var handleMinHeight = function() {
		...
		if (win_h > 0 ? win_h : screen.height) {
			$(".content-body").css("min-height", (window.innerHeight - 58) + "px");
		};
	}
	...
	var handleDatePicker = function() {
		$(function () {
			if(jQuery('#datepicker,#datepicker2').length > 0){
		...
		$(".dz-load-more").on('click', function(e)
		{
			...
			$.ajax({
				...
				success: function(data) {
					...
					$('.dz-load-more .fa-refresh').remove();
				}
			})
		});
	}
